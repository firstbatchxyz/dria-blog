...
|       `DEEPSEEK_R1`       |               `deepseek-r1`                |                             R1 Models                              |
...
|     `DEEPSEEK_R1_70B_OR`     |          `deepseek/deepseek-r1-distill-llama-70b`          |                         OpenRouter Models                          |
|     `DEEPSEEK_R1_OR`     |          `deepseek/deepseek-r1`          |                         OpenRouter Models                          |
|   `TINY_AGENT_0_5B`   |       `driaforall/tiny-agent-a:0.5b`       |                            Dria Models                             |
|   `TINY_AGENT_1_5B`   |       `driaforall/tiny-agent-a:1.5b`       |                            Dria Models                             |
|   `TINY_AGENT_3B`   |        `driaforall/tiny-agent-a:3b`        |                            Dria Models                             |
